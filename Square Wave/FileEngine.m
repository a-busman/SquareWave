...
+ (BOOL)parseAudioFileContents:(NSString *)filePath {
    ...
    [FileEngine addToDatabase:emu filePath:finalPath];
 ...
 * @param [in]filePath Path of file to parse
 */
+ (void)addToDatabase:(Music_Emu *)emu filePath:(NSString *)filePath {
    BOOL        success  = false;
    gme_info_t *gameInfo = nil;
    ...
    __DEBUG_FE(@"database location: %@", [[[[delegate persistenStoreCoordinator] persistentStores] firstObject] URL]);
